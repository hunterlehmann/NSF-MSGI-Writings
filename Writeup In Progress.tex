...
\begin{document}
	...
	This is precisely the action of $N_x$ non-interacting copise of a 1-dimensional standard Ising model with free boundary conditions and zero external magnetic field, which was investigated in Section 2.2.
