...
\begin{document}
	...
	We define 
		\[ L(\vec{x},\vec{y})=e^{-\frac{1}{2}S(\vec{x}^2+\vec{y}^2)+\frac{1}{4}\beta J(\vec{x}^TM\vec{x}+\vec{y}^TM\vec{y})+\beta J\vec{x}\vec{y}+\frac{1}{2}\beta h \sum_{i=1}^{\widetilde{N}} (x_i + y_i)}, \]
