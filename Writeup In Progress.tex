...
\begin{document}
	...
	When our configuration space is $S^1$, we can parameterize the spins $\vec{x_i}=(\cos(\theta_i),\sin(\theta_i))$ for $\theta \in [0,2\pi)$. 
	...
	Recall that the set $B=\{\psi_m:=\frac{1}{\sqrt{2\pi}} e^{im\theta} \mid m \in \Z \}$ forms an orthonormal basis for $L^2([0,2\pi])$.
	...
	\begin{align}
		(\hat{T}\psi_m)(\theta) &\approx \frac{1}{\sqrt{2\pi}}e^{\frac{\lambda\tau h}{2} \cos(\theta)+1/\tau} \sum_{\ell\in \Z} e^{i\ell\theta-\tau\ell^2/2}\left(\int_{0}^{2\pi} (1-\left(\frac{\lambda \tau h}{2}\cos(\phi) \right)^2 e^{i(m-\ell)\phi}\right) \, d\phi, \nonumber \\
		&= \frac{1}{\sqrt{2\pi}}e^{\frac{\lambda\tau h}{2} \cos(\theta)+1/\tau} \sum_{\ell\in \Z} e^{i\ell\theta-\tau\ell^2/2}\left( 2\pi \delta_{\ell,m}- \frac{\lambda^2 \tau^2 h^2}{4}\int_{0}^{2\pi} \cos^2(\phi)  e^{i(m-\ell)\phi}\right) \, d\phi, \nonumber \\
		&= \frac{1}{\sqrt{2\pi}}e^{\frac{\lambda\tau h}{2} \cos(\theta)+1/\tau} \sum_{\ell\in \Z} e^{i\ell\theta-\tau\ell^2/2}\left( 2\pi \delta_{\ell,m}- \frac{\lambda^2 \tau^2 h^2}{4}\int_{0}^{2\pi} \left( \frac{e^{i\theta}+e^{-i\theta}}{2} \right)^2  e^{i(m-\ell)\phi}\right) \, d\phi, \nonumber \\
		&= \frac{1}{\sqrt{2\pi}} e^{\frac{\lambda\tau h}{2} \cos(\theta)+1/\tau} \sum_{\ell\in \Z} 2\pi e^{i\ell\theta-\tau\ell^2/2}\left(\delta_{\ell,m}- \frac{\lambda^2 \tau^2 h^2}{16}(\delta_{m+2,\ell}+2\delta_{m,\ell}+\delta_{m-2,\ell}) \right), \nonumber \\
		&= \sqrt{2\pi} e^{\frac{\lambda\tau h}{2} \cos(\theta)+1/\tau} ( e^{im\theta} e^{ - \tau m^2/2}- \frac{\lambda^2 \tau^2 h^2}{16} (e^{i(m+2)\theta} e^{ - \tau (m+2)^2/2}+ \nonumber\\
		& \qquad\qquad\qquad\qquad\qquad\qquad 2e^{im\theta} e^{ - \tau m^2/2}+e^{i(m-2)\theta} e^{ - \tau (m-2)^2/2} ) ). 
	\end{align}
