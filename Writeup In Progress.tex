...
\begin{document}
    ...
    \begin{equation}\label{eqn:1+1IsingHamiltonian}
    ...
    A Hamiltonian of the form of \cref{eqn:1+1IsingHamiltonian} can be rewritten in terms of Fermion operators $\{a_j,a^\dagger_j\}_{j=1}^n$ that satisfy the \emph{canonical commutation relations} (CCRs) 
    ...
    \begin{enumerate}
    	\item Use duality to swap the roles of $\hat{\sigma}_1$ and $\hat{\sigma}_3$ in \cref{eqn:1+1IsingHamiltonian}.
