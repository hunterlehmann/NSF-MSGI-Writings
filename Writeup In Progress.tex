...
\begin{document}
	...
	The operators $E,U \in U(1)$ on the links are related by the commutation relations
	...
	To define a finite approximation to this model, we need to replace the operators $U,E \in U(1)$ with operators in some finite dimensional space. 
