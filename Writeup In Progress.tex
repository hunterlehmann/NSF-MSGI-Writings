...
\begin{document}
	...
	As an example of the general theory of the previous section applied to a finite group, we consider a 1-d lattice with gauge group $G\cong D_3$, extending the example found in \cite{ZoharBurrello15}[Appendix 1].
